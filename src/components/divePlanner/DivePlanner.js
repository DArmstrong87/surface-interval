...
export const DivePlanner = () => {
    ...
    return (<>
        ...
        <section className="air-selectors">
            <input type="radio" onChange={() => setAir('air')} checked={air === 'air'} />
            <label>Air</label>
            <input type="radio" onChange={() => setAir('EANx32')} checked={air === 'EANx32'} />
            <label>EANx32</label>
            <input type="radio" onChange={() => setAir('EANx36')} checked={air === 'EANx36'} />
            <label>EANx36</label>
        </section>
