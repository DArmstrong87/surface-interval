...
export const EditConditions = ({currentDive, setDive}) => {
    ...
    return (<>
        ...
        <section className="specialties">
            <div className="specialtyColumn">
                <ul className="specialtyList">
                    <li>
                        <input type="checkbox" value="false" checked={currentDive.isBoat ? true : false} className="logCheckbox" onChange={(event) => {
                    ...
                    <li>
                        <input type="checkbox" value="false" checked={currentDive.isSurge ? true : false} className="logCheckbox" onChange={(event) => {
                            const copy = { ...currentDive }
            ...
            <div className="specialtyColumn">
                <ul className="specialtyList">
                    <li>
                        <input type="checkbox" checked={currentDive.isCurrent ? true : false} className="logCheckbox" onChange={(event) => {
                            const copy = { ...currentDive }
                    ...
                    <li>
                        <input type="checkbox" checked={currentDive.isWaves ? true : false} className="logCheckbox" onChange={(event) => {
                            const copy = { ...currentDive }
            ...
            <div className="specialtyColumn">
                <ul className="specialtyList">
                    <li>
                        <input type="checkbox" checked={currentDive.isShore ? true : false} className="logCheckbox" onChange={(event) => {
                            const copy = { ...currentDive }
        ...
        <fieldset>
            ...
            <input type="number" width="20px" value={currentDive.waterTemp} onChange={(event) => {
                const copy = { ...currentDive }
